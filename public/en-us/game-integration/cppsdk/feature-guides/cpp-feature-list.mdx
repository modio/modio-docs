...
custom_edit_url: https://github.com/modio/modio-sdk-internal/blob/develop/doc/cpp-feature-list.mdx
---
...
* **Core Functions**: Work through the [C++ SDK Getting Started Guides](https://docs.mod.io/cppsdk#c-sdk-core-setup-guides) to fully integrate the core functionality of the SDK.
...
| -------- | ------- | ------- |
| User Authentication   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/user-authentication)   |
| Search for UGC   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/searching-ugc)   |
| Subscribe to UGC   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/subscribing)   |
| Add UGC   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/adding-ugc)   |
| Collections   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/collections)   |
...
| -------- | ------- | ------- |
| [Marketplace](https://docs.mod.io/monetization/marketplace)   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/marketplace)   |
| [Metrics](https://docs.mod.io/metrics)   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/metrics)   |
| [Temporary Mod Sets](https://docs.mod.io/multiplayer/temporary-mods)   | Yes    | [Setup Guide](https://docs.mod.io/cppsdk/temporary-mods)   |
