...
custom_edit_url: https://github.com/modio/modio-ue4-internal/blob/develop/Plugins/Modio/Doc/getting-started/mute-user.mdx
---
...
To mute a user, call [`MuteUserAsync`](https://docs.mod.io/unrealref/#K2_MuteUserAsync) with the corresponding `ModioUserID` and a callback.
...
To perform the inverse operation call [`UnmuteUserAsync`](https://docs.mod.io/unrealref/#K2_UnmuteUserAsync) with the corresponding `ModioUserID` and a callback.
...
[`GetMutedUsersAsync`](https://docs.mod.io/unrealref/#K2_GetMutedUsersAsync) returns a list of users previously muted by an authenticated user. 
