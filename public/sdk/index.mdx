...
Welcome to the mod.io SDK, built using C++. It allows game developers to host and automatically install user-generated content in their games. It connects to the [mod.io REST API](https://docs.mod.io).
