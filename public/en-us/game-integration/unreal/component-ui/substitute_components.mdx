...
Substitutability of components is one of the core design features of the mod.io [Component UI](/in-game-ui/component) framework. This guide explains how mod.io UI interfaces enable the substituting of mod.io default components for your own components in the template implementation of the component UI framework.
