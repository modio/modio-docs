...
[Cloud Cooking](/cloud-cooking) provides mod.io managed infrastructure that supports preparation of content for platforms that are only available under non-disclosure agreements, such as consoles.
...
Now Cloud Cooking has been enabled for your game, head over to the [Cloud Cooking Configuration](/cloud-cooking/configuration) guide to begin the onboarding process.