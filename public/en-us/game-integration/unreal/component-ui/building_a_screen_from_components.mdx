...
custom_edit_url: https://github.com/modio/modio-ue4-internal/blob/develop/Plugins/ModioComponentUI/Doc/doc_root/en-us/component-ui/building_a_screen_from_components.mdx
---

# Building a UGC Browser

The majority of work involved in implementing the mod.io [Component UI](/in-game-ui/component) framework will be building custom UI layouts for consuming content from mod.io by assembling components into more complex layouts.  This is a step-by-step guide demonstrating the appropriate workflow for building such a screen. 
