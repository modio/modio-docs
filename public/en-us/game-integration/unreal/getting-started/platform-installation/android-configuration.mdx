...
custom_edit_url: https://github.com/modio/modio-ue4-internal/blob/develop/Plugins/Modio/Doc/doc_root/en-us/getting-started/platform-installation/android-configuration.mdx
---

# Android Configuration

:::important[Find your guide]
This setup guide is intended for those building for Android. If that's not you, continue to work through the [Unreal Engine Getting Started Guides](/unreal#unreal-engine-core-plugin-guides) to implement mod.io's core functionality.
:::

This guide covers

* [Single Sign-On (5.4 onwards)](#single-sign-on-54-onwards)
* [Single Sign-On (Pre-5.4)](#single-sign-on-pre-54)
...
* If you are on a Source build, open `Engine\Plugins\Online\OnlineSubsystemGoogle\OnlineSubsystemGoogle.uplugin` and add Android to the `PlatformAllowList` array. 
* If you are on a Launcher build, you can simply copy this plugin from this directory into your projects Plugins directory and make the appropriate change.
