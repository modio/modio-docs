...
![Virtual Currency Pack Listing Page](img/virtual-currency-pack-page.png)

:::note
Players are able to purchase Virtual Currency to exchange for UGC content, or purchase content directly when set up with USD Pricing.
:::

![Marketplace Tab](img/marketplace-tab.png)
...
Creators are able to list content on the Marketplace for defined prices, once listed on the Marketplace, players are able to purchase said content using their Virtual Currency (or perform direct purchases when set up with USD Pricing). Player Virtual Currency balances are unique and specific to each game to meet compliance with external platforms.

![UGC Purchase Flow](img/ugc-purchase.png)

:::note
Players can utilize their Virtual Currency balance to exchange for premium UGC content.
:::
...
![Refund Transaction Flow](img/refund.png)
