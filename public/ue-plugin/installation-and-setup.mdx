...
slug: /ue-plugin/installation-and-setup
sidebar_position: 1
---
...
The plugin ships with a fully functional UI, featuring mod browsing, searching and collection management. If you want to use the UI in the game, you can read the [UI Documentation](ui-documentation.adoc)

## Profiling

The mod.io SDK ships with some profiling features that are integrated into Unreal’s stat commands. You can read more about enabling profiling [here](profiling.adoc).
