...
Players are able to purchase [virtual currency packs](/monetization/onboarding#virtual-currency-packs), either directly through your game page on mod.io or any platform you wish to make this available on (PC storefronts, console stores, or your own). Players can then use this currency to purchase premium UGC, the currency is paid to creators and the game publisher, in the form of Creator Credits, based on the revenue split you set in the [Monetization settings](/monetization/onboarding#monetization-settings).
...
Player purchases Virtual Currency directly on mod.io (or using our web site or embedded web app). The price is $0.01 per Virtual Currency. In this example, we’ll assume the sale of a currency pack of 1000 Virtual Currency for $10.
...
We charge the Virtual Currency wholesale amount ($0.0052 per Virtual Currency sold). The Virtual Currency wholesale amount covers mod.io's fee, and the value of the currency in the economy.

mod.io gets $0.0012 per Virtual Currency of the wholesale amount. In this case, this would be $1.2. The Virtual Currency pool gets $0.004 per Virtual Currency of that wholesale amount. In this case, that would be $4. This is the value of the Virtual Currency in the Marketplace economy.
...
| mod.io   | $0.0012 per Virtual Currency  | $0.12                           | $0.60                           | $1.20                             |
| VC pool  | $0.004 per Virtual Currency   | $0.40                           | $2.00                           | $4.00                             |
| Studio   | What's left                   | $0.18                           | $0.90                           | $1.80                             |

The above covers the transaction for the purchase of Virtual Currency Packs. Following this, when the player purchases a piece of content using their Virtual Currency, we apply the revenue split set by the studio. If a UGC item was sold for 100 Virtual Currency and the studio had 70% go to the creator and 30% go to the studio then the creator would get $2.8 and the studio would get $1.2 on top of the money they’ve already earned from the currency pack sale.
