...
:::note
The Test environment is available for usage in limited circumstances only. [All games should be set up on the Live environment](/unreal/installation-and-setup#using-the-live-environment). Set your game to **hidden** to restrict access during the testing phase.
:::
