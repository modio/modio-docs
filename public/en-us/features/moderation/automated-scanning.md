...
![Media scanning](img/media-scanning.png)

## UGC files

All files and binaries submitted to mod.io are validated via a series of rules, depending on the file’s purpose. 
...
![File scanning](img/file-scanning.png)
...
![File schema validation](img/file-schema-validation.png)
