---
id: ui-layouts
title: Layouts & Prefabs 
slug: /unity/template-ui/ui-layouts/
custom_edit_url: https://github.com/modio/modio-ue4-internal/tree/main/Plugins/ModioComponentUI/Doc/doc_root/en-us/template-ui/ui_layotus.mdx
---

## Layout Breakdown

Once you have the mod.io plugin installed,  then modifying the Template UI in the **ModioComponentUI** scene to suit your game is simple, assuming you are already familiar with UI Layouts in Unity.
...
The list of mods is populated in GridLayout inside Modbrowser_GridView, with the mods size and padding being set by its Grid Layout Group component.\
&nbsp;
...
Marketplace Cost is controls by the **NameInfo** Modio UI Mod Properties component, letting the name text field scale down to fit the price/purchased state if the mod is a Premium mod.
&nbsp;
...
The Template UIs core strings come localized in 18 languages: <i>English, German, Italian, French, Polish, Portuguese, Japanese, Korean, Russian, Spanish, Chinese (Simplified), Chinese (Traditional), Ukranian, Bulgarian, Thai, Hungarian, Indonesian, Turkish & Latin American.</i>
