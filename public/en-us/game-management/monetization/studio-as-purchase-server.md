...
Operating your own a Purchase Server requires a strong understanding of the role you must play in initiating transaction from your secure server. If you want mod.io to sync platform entitlements and purchases, please see our guide for [using mod.io as the purchase server](/monetization/modio-as-purchase-server/). Covered in this section is:
