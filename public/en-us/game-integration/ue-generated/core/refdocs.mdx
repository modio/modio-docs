...
```cpp
EModioOpenStoreResult RequestOpenStore(FStoreClosedDelegate Callback, FString SKU)
```
...
```cpp
void K2_GetAvailableUserEntitlementsAsync(FOnGetAvailableUserEntitlementsDelegate Callback)
```
...
#### Get Portal Interface Object


![nd_img_ModioSubsystem_GetPortalInterfaceObject.png](img/refdocs/nd_img_ModioSubsystem_GetPortalInterfaceObject.png)
...
![nd_img_ModioSubsystem_GetPortalInterface.png](img/refdocs/nd_img_ModioSubsystem_GetPortalInterface.png)
