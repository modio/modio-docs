...
custom_edit_url: https://github.com/modio/modio-unity-internal/tree/main/docs/public/feature-guides/unity-template-ui/unity-tui-functionality.md
---
...
The UGC Browser’s content is split into 3 main pages:

* RECENT & TRENDING for browsing your game’s mods with different sorting filters applied.
* LIBRARY for handling the users Subscribed & Purchased UGC (Purchased UGC being available with [Marketplace](https://docs.mod.io/monetization/marketplace) features enabled).
