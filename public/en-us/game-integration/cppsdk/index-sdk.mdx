...
You can download the mod.io C++ SDK from [GitHub](https://github.com/modio/modio-sdk). Once you have, follow the [setup](/cppsdk/setup/) guide to set up your game or application to use the SDK. If you are using Unreal Engine, you can get our official Unreal Engine plugin [on GitHub](https://github.com/modio/modio-ue).
...
The mod.io SDK supports all current-generation desktop platforms, mobile and consoles. For access to Windows (GDK), XBox, PlayStation®4, PlayStation®5 or Switch, follow the [instructions here](/platforms/console-sdks/).
