...
| | | |
|-|-|-|
| [`Modio::Optional<StorageType>`](#_2249073032064) | Value |  |
</RefTable>
...
| | | |
|-|-|-|
| [`ListType`](#_2249073637472) | InternalList |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | RootDirectory | Path to a directory to treat as the root of the mod. The SDK will compress all contents of this folder into a .zip archive, with a relative path based on this directory. This directory will not be created itself, the contents will exist at the top level of the archive. |
| [`Modio::Optional<std::string>`](#_2249071261648) | Version | Optional version string for this modfile release |
| [`Modio::Optional<std::string>`](#_2249071261648) | Changelog | Optional changelog string for this modfile release |
| [`Modio::Optional<_Bool>`](#_2249075727856) | bSetAsActive | Should this mod be set as active/latest release? Defaults to true if not set. |
| [`Modio::Optional<std::string>`](#_2249071261648) | MetadataBlob | Optional metadata blob for this mod |
| [`Modio::Optional<std::vector<Modio::ModfilePlatform> >`](#_2249075967152) | Platforms | Optional vector of platforms for this modfile |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | PathToLogoFile | Path to the logo for the mod. Must point to a valid file on disk or the mod will not be created on the server. |
| [`std::string`](#_2249037487584) | Name | The name of the mod |
| [`std::string`](#_2249037487584) | Summary | A brief summary of what the mod is |
| [`Modio::Optional<std::string>`](#_2249071261648) | NamePath | Optional override for the name 'slug' in the mod's URL |
| [`Modio::Optional<Modio::ObjectVisibility>`](#_2249076765840) | Visibility | Optional override for the mod's visibility status. Defaults to Public (1) |
| [`Modio::Optional<std::string>`](#_2249071261648) | Description | Optional long description of the mod |
| [`Modio::Optional<std::string>`](#_2249071261648) | HomepageURL | Optional URL to the mod's homepage. Must be a valid URL |
| [`Modio::Optional<std::size_t>`](#_2249077279536) | Stock | Optional quantity limit on the mod |
| [`Modio::Optional<Modio::MaturityOption>`](#_2249077518256) | MaturityRating | Bitwise mask of flags indicating mature content |
| [`Modio::Optional<std::string>`](#_2249071261648) | MetadataBlob | Optional metadata blob for this mod |
| [`Modio::Optional<std::vector<std::string> >`](#_2249078032096) | Tags | Optional list of mod tags. All tags must be supported by the parent game to be applied |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::Optional<std::string>`](#_2249071261648) | Name | The name of the mod |
| [`Modio::Optional<std::string>`](#_2249071261648) | Summary | A brief summary of what the mod is |
| [`Modio::Optional<std::string>`](#_2249071261648) | NamePath | Optional override for the name 'slug' in the mod's URL |
| [`Modio::Optional<Modio::ObjectVisibility>`](#_2249076765840) | Visibility | Optional override for the mod's visibility status. Defaults to Public (1) |
| [`Modio::Optional<std::string>`](#_2249071261648) | Description | Optional long description of the mod |
| [`Modio::Optional<std::string>`](#_2249071261648) | HomepageURL | Optional URL to the mod's homepage. Must be a valid URL |
| [`Modio::Optional<Modio::MaturityOption>`](#_2249077518256) | MaturityRating | Bitwise mask of flags indicating mature content |
| [`Modio::Optional<std::string>`](#_2249071261648) | MetadataBlob | Optional metadata blob for this mod |
| [`Modio::Optional<std::string>`](#_2249071261648) | LogoPath | Optional path to a new logo image |
| [`Modio::Optional<std::vector<std::string> >`](#_2249078032096) | Tags | Optional tags vector for this mod |
</RefTable>
...
##### RevenueFilterType {#_2249081882208} 
...
| | | |
|-|-|-|
| [`SortFieldType`](#_2249081878336) | SortField |  |
| [`SortDirection`](#_2249081881200) | Direction |  |
| [`std::vector<Modio::UserID>`](#_2249081891168) | AuthorUserIds |  |
| [`std::vector<std::string>`](#_2249059514272) | SearchKeywords |  |
| [`Modio::Optional<std::chrono::system_clock::time_point>`](#_2249082058480) | DateRangeBegin |  |
| [`Modio::Optional<std::chrono::system_clock::time_point>`](#_2249082058480) | DateRangeEnd |  |
| [`std::vector<std::string>`](#_2249059514272) | Tags |  |
| [`std::vector<std::string>`](#_2249059514272) | ExcludedTags |  |
| [`std::vector<Modio::ModID>`](#_2249072325168) | IncludedIDs |  |
| [`std::vector<Modio::ModID>`](#_2249072325168) | ExcludedIDs |  |
| [`Modio::Optional<RevenueFilterType>`](#_2249082318832) | Revenue |  |
| [`Modio::Optional<MaturityOption>`](#_2249077518256) | Maturity |  |
| [`Modio::Optional<std::string>`](#_2249071261648) | MetadataBlobSearchString |  |
| [`_Bool`](#_2248993237888) | IsPaged |  |
| [`std::size_t`](#_2248993238240) | Index |  |
| [`std::size_t`](#_2248993238240) | Count |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int32_t`](#_2248993238016) | PageIndex |  |
| [`std::int32_t`](#_2248993238016) | PageSize |  |
| [`std::int32_t`](#_2248993238016) | PageCount |  |
| [`std::int32_t`](#_2248993238016) | TotalResultCount |  |
| [`std::int32_t`](#_2248993238016) | ResultCount |  |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | ID | The ID of the mod |
| [`std::atomic<Modio::ModState>`](#_2249083990240) | CurrentState | The status of the mod, is it pending installation, is it installed but needing an update, etc |
| [`Modio::Optional<Modio::ModState>`](#_2249084066480) | RollbackState |  |
| [`ModInfo`](#_2249074908352) | ModProfile | Mod descriptor from the REST API |
| [`std::atomic<uint8_t>`](#_2249040321696) | LocalUserSubscriptionCount | Reference counting to allow automatic uninstallation of unused local mods |
| [`std::set<Modio::UserID>`](#_2249084381248) | LocalUserSubscriptions |  |
| [`std::string`](#_2249037487584) | PathOnDisk |  |
| [`Modio::FileSize`](#_2249071041248) | SizeOnDisk |  |
| [`std::atomic<_Bool>`](#_2249040319968) | ShouldNotRetry | flag if this mod should not be processed because it encountered an unrecoverable error during installation/update. This should not be saved to disk as we will more than likely want to retry next session |
| [`Modio::ErrorCode`](#_2249042265104) | NeverRetryReason |  |
| [`Modio::ErrorCode`](#_2249042265104) | LastErrorCode |  |
| [`uint8_t`](#_2248993238112) | RetriesRemainingThisSession |  |
</RefTable>
...
##### EModProgressState {#_2249084829456} 
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | ID | The mod ID of the mod being processed |
</RefTable>
...
| | | |
|-|-|-|
| [`std::vector<Modio::ModManagementEvent>`](#_2249085656992) | InternalData |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int64_t`](#_2248993238080) | TotalFilesize | Total size of all the dependency files in bytes. |
| [`std::int64_t`](#_2248993238080) | TotalFilesizeUncompressed | Total Size of the uncompressed dependency files in bytes. |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::Optional<Modio::EntitlementWalletBalance>`](#_2249153102656) | WalletBalance | Updated wallet balance from syncing entitlements |
</RefTable>
...
| | | |
|-|-|-|
| [`UnderlyingIntegerType`](#_2248994162480) | Value |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | InternalCode |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | InternalAddress |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | InternalApiKey |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | InternalGuid |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | AuthToken | AuthToken String received by an authentication provider, that later is used to verify a user on the mod.io API |
| [`Modio::Optional<std::string>`](#_2249071261648) | UserEmail | UserEmail Optional string that associates an email with a user |
| [`_Bool`](#_2248993237888) | bUserHasAcceptedTerms | bUserHasAcceptedTerms Boolean value that signals when a user has accepted the mod.io Terms of Service. True when they are accepted, false otherwise. |
| [`_Bool`](#_2248993237888) | bURLEncodeAuthToken | bURLEncodeAuthToken Boolean value to let the SDK know if the AuthToken requires URL encoding before sending the string to the mod.io API. By default, it would not perform URL encoding. |
| [`std::map<std::string, std::string>`](#_2249071526496) | ExtendedParameters | ExtendedParameters A map to store extended parameters required by some providers. |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | Field | String description of the field failing validation |
| [`std::string`](#_2249037487584) | Error | String containing the reason for the validation failure |
</RefTable>
...
| | | |
|-|-|-|
| [`std::map<std::string, std::string>`](#_2249071526496) | ExtendedParameters | ExtendedParameters A map to store extended parameters required by some portals. |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::Optional<Modio::Guid>`](#_2249072081152) | SessionId | Set a custom Session Id to be used in the metrics service for your session |
| [`std::vector<Modio::ModID>`](#_2249072325168) | ModIds | Includes mods which will be tracked as part of the metrics service |
</RefTable>
...
##### VirusScanStatus {#_2249072975216} 
...
| | | |
|-|-|-|
| [`Modio::FileMetadataID`](#_2249071018544) | MetadataId | Unique modfile id. |
| [`Modio::ModID`](#_2249069302624) | ModId | Unique mod id. |
| [`std::int64_t`](#_2248993238080) | DateAdded | Unix timestamp of date file was added. |
| [`VirusScanStatus`](#_2249072975216) | CurrentVirusScanStatus | Current virus scan status of the file. For newly added files that have yet to be scanned this field will change frequently until a scan is complete |
| [`VirusStatus`](#_2249072977008) | CurrentVirusStatus | Was a virus detected? |
| [`std::int64_t`](#_2248993238080) | Filesize | Size of the file in bytes. |
| [`std::int64_t`](#_2248993238080) | FilesizeUncompressed | Size of the uncompressed file in bytes. |
| [`std::string`](#_2249037487584) | Filename | Filename including extension. |
| [`std::string`](#_2249037487584) | Version | Release version this file represents. |
| [`std::string`](#_2249037487584) | Changelog | Changelog for the file. |
| [`std::string`](#_2249037487584) | MetadataBlob | Metadata stored by the game developer for this file. |
| [`std::string`](#_2249037487584) | DownloadBinaryURL | Modfile download URL |
| [`std::int64_t`](#_2248993238080) | DownloadExpiryDate | Modfile download expiry date |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int64_t`](#_2248993238080) | PopularityRankPosition | Current rank of the mod. |
| [`std::int64_t`](#_2248993238080) | PopularityRankTotalMods | Number of ranking spots the current rank is measured against. |
| [`std::int64_t`](#_2248993238080) | DownloadsTotal | Number of total mod downloads. |
| [`std::int64_t`](#_2248993238080) | SubscribersTotal | Number of total users who have subscribed to the mod. |
| [`std::int64_t`](#_2248993238080) | RatingTotal | Number of times this mod has been rated. |
| [`std::int64_t`](#_2248993238080) | RatingPositive | Number of positive ratings. |
| [`std::int64_t`](#_2248993238080) | RatingNegative | Number of negative ratings. |
| [`std::int64_t`](#_2248993238080) | RatingPercentagePositive | Number of positive ratings, divided by the total ratings to determine it’s percentage score. |
| [`double`](#_2248993238304) | RatingWeightedAggregate | Overall rating of this item calculated using the [Wilson score confidence interval](https://www.evanmiller.org/how-not-to-sort-by-average-Ratinghtml). This column is good to sort on, as it will order items based on number of ratings and will place items with many positive ratings above those with a higher score but fewer ratings. |
| [`std::string`](#_2249037487584) | RatingDisplayText | Textual representation of the rating in format: Overwhelmingly Positive -> Very Positive -> Positive -> Mostly Positive -> Mixed -> Negative -> Mostly Negative -> Very Negative -> Overwhelmingly Negative -> Unrated |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::UserID`](#_2249069283296) | UserId | Unique id for the user |
| [`std::string`](#_2249037487584) | Username | Username of the user |
| [`Modio::Optional<Modio::Detail::OAuthToken>`](#_2249074184000) | AuthToken | Authentification token of the user |
| [`std::int64_t`](#_2248993238080) | DateOnline | Unix timestamp the user was last online |
| [`std::string`](#_2249037487584) | ProfileUrl | URL of the user's mod.io profile |
| [`Modio::Detail::Avatar`](#_2249074145968) | Avatar | Cached information about the user's avatar |
| [`std::string`](#_2249037487584) | DisplayNamePortal | The display name of the User for the given Portal that the mod search is coming from * ie if the Portal is PSN, then this is the owning user's PSN profile name if accounts are linked. |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | Tag |  |
| [`std::string`](#_2249037487584) | TagLocalized |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | Key |  |
| [`std::string`](#_2249037487584) | Value |  |
</RefTable>
...
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | ModId | Unique Mod ID |
| [`std::string`](#_2249037487584) | ProfileName | Name of the mod |
| [`std::string`](#_2249037487584) | ProfileSummary | Summary of the mod |
| [`std::string`](#_2249037487584) | ProfileDescription | Detailed description in HTML format |
| [`std::string`](#_2249037487584) | ProfileDescriptionPlaintext | Detailed description in plaintext |
| [`std::string`](#_2249037487584) | ProfileURL | URL to the mod profile |
| [`Modio::User`](#_2249074181664) | ProfileSubmittedBy | Information on the user who submitted the mod |
| [`std::int64_t`](#_2248993238080) | ProfileDateAdded | Unix timestamp of the date the mod was registered |
| [`std::int64_t`](#_2248993238080) | ProfileDateUpdated | Unix timestamp of the date the mod was updated |
| [`std::int64_t`](#_2248993238080) | ProfileDateLive | Unix timestamp of the date the mod was marked live |
| [`Modio::ProfileMaturity`](#_2249073070112) | ProfileMaturityOption | Object representing a mod.io user profile	* Maturity options flagged by the mod developer, this is only relevant if the parent game allows mods to	* be labeled as mature. The value of this field will default to None unless the parent game allows * to flag mature content. |
| [`std::string`](#_2249037487584) | MetadataBlob | Metadata stored by the game developer. |
| [`Modio::Optional<Modio::FileMetadata>`](#_2249074915920) | FileInfo | Information about the mod's most recent public release |
| [`std::vector<Modio::Metadata>`](#_2249075161840) | MetadataKvp | Arbitrary key-value metadata set for this mod |
| [`std::vector<Modio::ModTag>`](#_2249075302032) | Tags | Tags this mod has set |
| [`std::size_t`](#_2248993238240) | NumGalleryImages | Number of images in the mod's media gallery |
| [`Modio::GalleryList`](#_2249074696704) | GalleryImages | List of images in the mod's media gallery |
| [`Modio::YoutubeURLList`](#_2249074032144) | YoutubeURLs | List of youtube links provided by the creator of the mod |
| [`Modio::SketchfabURLList`](#_2249074044640) | SketchfabURLs | List of sketchfab links provided by the creator of the mod |
| [`Modio::ModStats`](#_2249073011616) | Stats | Stats and rating information for the mod |
| [`Modio::Detail::Logo`](#_2249074857600) | ModLogo | Media data related to the mod logo |
| [`std::string`](#_2249037487584) | Version | The current ModInfo version. This property is updated when changes to the class happen. |
| [`Modio::ModServerSideStatus`](#_2249074907200) | ModStatus | The current ModStatus on the server: Accepted, NotAccepted, or Deleted. |
| [`Modio::ObjectVisibility`](#_2249072073760) | Visibility | The visibility status of the mod, default to Public |
| [`uint64_t`](#_2248993238240) | Price | Price of this mod |
| [`_Bool`](#_2248993237888) | Dependencies | If this mod has any direct dependencie. |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::GameID`](#_2249071044496) | GameID | The mod.io-provided ID for the game. |
| [`Modio::ApiKey`](#_2249069268688) | APIKey | The mod.io-provided API key for your application or game. |
| [`Modio::UserHandleType`](#_2249037487584) | User | Unique identifier for the local session, which will optionally contain user data for an authenticated mod.io user (once authentication is completed). |
| [`Modio::Portal`](#_2249069191504) | PortalInUse | The storefront or distribution method to use. The API uses this parameter to serve platform-compliant user names. Use `Modio::Portal::None` if your title does not require this. |
| [`Modio::Environment`](#_2249069186384) | GameEnvironment | The mod.io environment you want to run the SDK on. |
| [`std::map<std::string, std::string>`](#_2249071526496) | ExtendedParameters | Platform-specific extended initialization parameters. See xref:Platform-specific Notes[] for more information regarding any special values your platform requires or supports. |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | ID | ID for the mod that the event occurred on |
| [`EventType`](#_2249085112608) | Event | What type of event occurred |
| [`Modio::ErrorCode`](#_2249042265104) | Status | Empty if operation completed successfully, truthy/contains error code if operation failed |
</RefTable>
...
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | ModID | Unique mod id. |
| [`std::string`](#_2249037487584) | ModName | Name of the mod |
| [`std::int64_t`](#_2248993238080) | DateAdded | Unix timestamp of the date the mod was registered |
| [`std::int64_t`](#_2248993238080) | DateUpdated | Unix timestamp of the date the mod was updated |
| [`std::uint8_t`](#_2248993238112) | DependencyDepth | The level at which this dependency sits. When greater than zero (0), it means that this dependency relies on additional dependencies. |
| [`Modio::Detail::Logo`](#_2249074857600) | Logo | Media data related to the mod logo |
| [`Modio::Optional<Modio::FileMetadata>`](#_2249074915920) | FileInfo | Information about the mod's most recent public release |
| [`Modio::ModServerSideStatus`](#_2249074907200) | Status | The current ModStatus on the server: Accepted, NotAccepted, or Deleted. |
| [`Modio::ObjectVisibility`](#_2249072073760) | Visibility | The visibility status of the mod, default to Public |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2248993238016) | TokensAllocated | Amount of tokens that were issued for this specific entitlement consumption |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | TransactionId | ID of the transaction to redeem this entitlement |
| [`Modio::EntitlementConsumptionState`](#_2249152930672) | TransactionState | State of the transaction |
| [`std::string`](#_2249037487584) | SkuId | ID of the SKU that we attempted to consume |
| [`_Bool`](#_2248993237888) | EntitlementConsumed | Whether this entitlement was consumed or not |
| [`Modio::EntitlementType`](#_2249152931920) | EntitlementType | Type of Entitlement that was consumed |
| [`Modio::EntitlementConsumptionVirtualCurrencyDetails`](#_2249152932672) | VirtualCurrencyDetails | Details about |
</RefTable>
...
| | | |
|-|-|-|
| [`uint64_t`](#_2248993238240) | Balance |  |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::GameID`](#_2249071044496) | GameID | Unique game id |
| [`std::int64_t`](#_2248993238080) | ModCountTotal | Available mod count for the game |
| [`std::int64_t`](#_2248993238080) | ModDownloadsToday | Mods downloaded today for the game |
| [`std::int64_t`](#_2248993238080) | ModDownloadsTotal | Total Mods downloaded for the game |
| [`std::int64_t`](#_2248993238080) | ModDownloadsDailyAverage | Average mods downloaded on a daily basis |
| [`std::int64_t`](#_2248993238080) | ModSubscribersTotal | Number of total users who have subscribed to the mods for the game |
| [`std::int64_t`](#_2248993238080) | DateExpires | Unix timestamp until this game's statistics are considered stale |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2249037487584) | TagGroupName | Raw unlocalized tag group name |
| [`std::vector<std::string>`](#_2249059514272) | TagGroupValues | Valid raw unlocalized tag values this group contains |
| [`std::map<std::string, std::string>`](#_2249071526496) | TagGroupNameLocData | Culture code -> localized tag category name mapping for all configured languages |
| [`std::vector<ModTagLocalizationData>`](#_2249038050880) | TagGroupValueLocData | Localization data for this tag category's values in all configured languages |
| [`_Bool`](#_2248993237888) | bAllowMultipleSelection | True if multiple tags from the group can be used simultaneously |
| [`_Bool`](#_2248993237888) | bHidden | True if only visible by admins |
| [`_Bool`](#_2248993237888) | bLocked | True if only editable by admins |
| [`std::string`](#_2249037487584) | Locale | the culture code for the mod.io locale at the time the mod.io API returned this data |
</RefTable>
...
| | | |
|-|-|-|
| [`struct TermsButtons`](#_2249155775312) | Buttons |  |
| [`struct TermsLinks`](#_2249155779776) | Links |  |
| [`std::string`](#_2249037487584) | TermsText | The plaintext version of the mod.io terms of use |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2249069302624) | AssociatedModID | The mod the purchase was for |
| [`uint64_t`](#_2248993238240) | Price | The price the mod was purchased for |
| [`uint64_t`](#_2248993238240) | UpdatedUserWalletBalance | The updated balance in the user's wallet after the transaction |
| [`Modio::ModInfo`](#_2249074908352) | Mod | ModInfo of the mod that was purchase and subscribed to |
</RefTable>
...
### ModfilePlatform {#_2249069197264} 
...
### AuthenticationProvider {#_2249072063424} 
...
### ObjectVisibility {#_2249072073760} 
...
### ModServerSideStatus {#_2249074907200} 
...
### FilesystemError {#_2249079461008} 
...
### ModManagementError {#_2249079694576} 
...
### ModValidationError {#_2249079732320} 
...
### MonetizationError {#_2249079767136} 
...
### ParentalControlRestriction {#_2249079808080} 
...
### PremiumFeaturesError {#_2249079883168} 
...
### ErrorConditionTypes {#_2249080354048} 
...
### EntitlementConsumptionState {#_2249152930672} 
...
### EntitlementType {#_2249152931920} 
...
### GameCommunityOptions {#_2249154066096} 
...
### GameMaturityOptions {#_2249154633728} 
...
### GameMonetizationOptions {#_2249154681632} 
