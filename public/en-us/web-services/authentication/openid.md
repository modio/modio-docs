...
5. The `iat` claim cannot be greater than the current epoch unix timestamp minus 10 seconds to account for clock skew.
6. The `exp` claim must be more than the current epoch unix timestamp plus 10 seconds to account for clock skew.
