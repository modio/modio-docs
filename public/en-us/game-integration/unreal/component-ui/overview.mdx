...
custom_edit_url: https://github.com/modio/modio-ue4-internal/blob/develop/Plugins/ModioComponentUI/Doc/doc_root/en-us/component-ui/overview.mdx
---

# Component UI Framework

[Component UI](/in-game-ui/component) for Unreal Engine provides a framework that lets you integrate mod.io plugin data and events into your game's UI. The following documentation will give you the tools to create a seamless UGC experience for your game.

:::note[Template UI]
If you are after a ready-made UGC browser, [Template UI](/in-game-ui/template) is a fully-featured UGC browser built using Component UI.
:::
