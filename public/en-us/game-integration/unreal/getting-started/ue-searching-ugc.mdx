...
After [initializing the plugin](initialization) and [authenticating a user](authentication), you can query the available mods using [`ListAllModsAsync`](/unreal/refdocs/#listallmodsasync). 
