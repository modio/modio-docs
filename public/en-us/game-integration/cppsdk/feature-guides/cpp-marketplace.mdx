...
To display the appropriate price, simply find the SKU Mapping for the current Portal that you are going to request the purchase on (ie Steam, PlayStation®, XBoxLive) and look up that SKU ID from your Platform SKUs from the previous step.
