...
#### ModioDefaultCarouselModListView 

A default implementation of IModioUIModListViewInterface which displays mods as a carousel. This widget inherits from UModioDefaultModListView.

###### Inheritance Hierarchy
-> ModioDefaultModListView-> ListView-> ListViewBase-> Widget-> Visual-> Object
...
![nd_img_ModioDefaultCarouselModListView_ScrollRow.png](img/refdocs/nd_img_ModioDefaultCarouselModListView_ScrollRow.png)
...
![nd_img_ModioDefaultCarouselModListView_NavigateInDirection.png](img/refdocs/nd_img_ModioDefaultCarouselModListView_NavigateInDirection.png)
...
##### Get Item Count on Screen


![nd_img_ModioDefaultCarouselModListView_GetItemCountOnScreen.png](img/refdocs/nd_img_ModioDefaultCarouselModListView_GetItemCountOnScreen.png)
...
| | | |
|-|-|-|
| `int32` | `DefaultLoopingListItemOffset` |  |
| `float` | `DefaultItemScrollOffset` |  |
| `float` | `MinimumLoopingTiles` |  |
| `bool` | `bLoopTiles` |  |
| `TSubclassOf<UUserWidget>` | `ViewMoreButtonClass` |  |
| `float` | `ScrollCheckPadding` |  |
| `bool` | `bScrollCheckViewMoreTileVisible` |  |
| `bool` | `bResetScrollWhenOffscreen` |  |
| `int32` | `OffscreenResetFrameCount` |  |
</RefTable>
...
| | | |
|-|-|-|
| `bool` | `bSelectFirstTileWhenFocused` |  |
...
| | | |
|-|-|-|
| `FModioScrollableOffsetChangedMulticast` | `OnScroll` | Passes `this` as ScrollableContext |
| `FModioOnObjectSelectionChangedMulticast` | `OnSelectedValueChanged` | Passes the bound value for which selection state has changed as `SelectedValue` |
</RefTable>
...
#### ModioForceFeedbackRefLibrary 

Library of functions for working with force feedback references
...
##### Set Tag Selected State

Sets the selection state for a given array of tags.

![nd_img_ModioModTagCategoryUIDetails_SetTagSelectedState.png](img/refdocs/nd_img_ModioModTagCategoryUIDetails_SetTagSelectedState.png)

```cpp
void SetTagSelectedState(TArray<FString> InTags, bool bSelectedState)
```
...
|`InTags`|The array of tags to set the selection state for|
|`bSelectedState`|The new selection state for the provided tags|
</RefTable>
...
| `TArray<TObjectPtr<UModioModTagInfoUI> >` | `BindableTagCategories` | Transient set of bindable tag categories for use in the UI |
</RefTable>
...
![nd_img_ModioModTagOptionsUIDetails_SetTagSelectedState.png](img/refdocs/nd_img_ModioModTagOptionsUIDetails_SetTagSelectedState.png)
...
Scroll the widget by the size of the visible content area

![nd_img_ModioScrollableWidget_ScrollVisibleArea.png](img/refdocs/nd_img_ModioScrollableWidget_ScrollVisibleArea.png)
...
|-|-|
|`Target`|`ModioScrollableWidget`|
|`bBackward`|If true, scroll up/left; if false, scroll down/right|
</RefTable>
...
##### Remove Scrollable Offset Changed Handler

Unsubscribes a delegate from receiving state change callbacks

![nd_img_ModioScrollableWidget_RemoveScrollableOffsetChangedHandler.png](img/refdocs/nd_img_ModioScrollableWidget_RemoveScrollableOffsetChangedHandler.png)

```cpp
void RemoveScrollableOffsetChangedHandler(FModioScrollableOffsetChanged Handler)
```
...
##### Can Scroll in Direction

Checks if the widget can scroll in the specified direction

![nd_img_ModioScrollableWidget_CanScrollInDirection.png](img/refdocs/nd_img_ModioScrollableWidget_CanScrollInDirection.png)
...
|-|-|
|`Target`|`ModioScrollableWidget`|
|`bBackward`|If true, check if can scroll up/left; if false check if can scroll down/right|
</RefTable>



###### Returns
True if the widget can scroll in the specified direction, false otherwise
...
##### Add Scrollable Offset Changed Handler

Registers a delegate that receives a callback when the scroll offset of the widget changes

![nd_img_ModioScrollableWidget_AddScrollableOffsetChangedHandler.png](img/refdocs/nd_img_ModioScrollableWidget_AddScrollableOffsetChangedHandler.png)

```cpp
void AddScrollableOffsetChangedHandler(FModioScrollableOffsetChanged Handler)
```
...
#### ModioSoundCueRefLibrary 

Library of functions for working with sound references
...
![nd_img_ModioTokenPackUIDetails_IsPurchasable.png](img/refdocs/nd_img_ModioTokenPackUIDetails_IsPurchasable.png)
...
##### Get Token Pack Display Price



![nd_img_ModioTokenPackUIDetails_GetTokenPackDisplayPrice.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetTokenPackDisplayPrice.png)
...
###### Returns
FText containing display string for the pack's current price
...
![nd_img_ModioTokenPackUIDetails_GetTitle.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetTitle.png)
...
Get the release date of the token pack

![nd_img_ModioTokenPackUIDetails_GetReleaseDate.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetReleaseDate.png)
...
###### Returns
The release date of the token pack
...
![nd_img_ModioTokenPackUIDetails_GetRegularPrice.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetRegularPrice.png)
...
![nd_img_ModioTokenPackUIDetails_GetNumericPrice.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetNumericPrice.png)
...
![nd_img_ModioTokenPackUIDetails_GetModioId.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetModioId.png)
...
![nd_img_ModioTokenPackUIDetails_GetLongDescription.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetLongDescription.png)
...
![nd_img_ModioTokenPackUIDetails_GetFields.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetFields.png)
...
Get the expiration date of the token pack

![nd_img_ModioTokenPackUIDetails_GetExpirationDate.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetExpirationDate.png)
...
###### Returns
The expiration date of the token pack
...
![nd_img_ModioTokenPackUIDetails_GetDescription.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetDescription.png)
...
Get the currency code of the token pack

![nd_img_ModioTokenPackUIDetails_GetCurrencyCode.png](img/refdocs/nd_img_ModioTokenPackUIDetails_GetCurrencyCode.png)
...
###### Returns
The currency code of the token pack
...
#### ModioUIInputModeChangedReceiver 
...
#### ModioUIInteractionFeedback 

Interface for objects that play feedback in response to a UI interaction
...
##### Play UISound Feedback

Plays the sound feedback associated with the given interaction key

![nd_img_ModioUIInteractionFeedback_PlayUISoundFeedback.png](img/refdocs/nd_img_ModioUIInteractionFeedback_PlayUISoundFeedback.png)
...
| | |
|-|-|
|`Target`|`ModioUIInteractionFeedback`|
|`UIFeedbackSound`|The feedback sound to play|
|`WorldContextObject`|Object used to resolve the world for sound playback (e.g. the calling widget)|
</RefTable>
...
##### Play UIForce Feedback

Plays the force feedback associated with the given interaction key

![nd_img_ModioUIInteractionFeedback_PlayUIForceFeedback.png](img/refdocs/nd_img_ModioUIInteractionFeedback_PlayUIForceFeedback.png)
...
|-|-|
|`Target`|`ModioUIInteractionFeedback`|
|`UIFeedbackForceEffect`|The force feedback effect to play|
|`PlayerController`|The player to play force feedback on|
</RefTable>
...
Sets the selection state of the given tags

![nd_img_ModioUIModTagSelector_SetTagSelectedState.png](img/refdocs/nd_img_ModioUIModTagSelector_SetTagSelectedState.png)
...
|`InTags`|Array of tag values to set|
|`bSelectedState`|Whether the given tags should be selected or unselected|
</RefTable>
...
##### Should Show Platform SKUInformation

Check if the UI should display SKU information when checking out a purchase for a mod

![nd_img_ModioUISubsystem_ShouldShowPlatformSKUInformation.png](img/refdocs/nd_img_ModioUISubsystem_ShouldShowPlatformSKUInformation.png)
...
###### Returns
True if the UI should display SKU information, false otherwise
...
##### Set UIInteraction Feedback Provider

Sets the provider object responsible for playing UI feedback (sound and force feedback).

![nd_img_ModioUISubsystem_SetUIInteractionFeedbackProvider.png](img/refdocs/nd_img_ModioUISubsystem_SetUIInteractionFeedbackProvider.png)

```cpp
void SetUIInteractionFeedbackProvider(TScriptInterface<IModioUIInteractionFeedback> InUIInteractionFeedbackProvider)
```
...
|-|-|
|`Target`|`ModioUISubsystem`|
|`InUIInteractionFeedbackProvider`|The object implementing the IModioUIInteractionFeedback interface that will play feedback.|
</RefTable>
...
##### Set Cached SKUMappings

Sets the cached set of platform-specific token packs so that UI elements can fetch the localized pricing when fiat monetization is enabled

![nd_img_ModioUISubsystem_SetCachedSKUMappings.png](img/refdocs/nd_img_ModioUISubsystem_SetCachedSKUMappings.png)
...
Requests to unfollow the given user for the currently authenticated user. Executes callbacks in implementations of IModioUIUserFollowingInfoReceiver.

![nd_img_ModioUISubsystem_RequestUnfollowUser.png](img/refdocs/nd_img_ModioUISubsystem_RequestUnfollowUser.png)
...
##### Request Show Token SKUPurchase UIWith Handler

Attempts to invoke the store with a specific SKU for the current platform.

![nd_img_ModioUISubsystem_RequestShowTokenSKUPurchaseUIWithHandler.png](img/refdocs/nd_img_ModioUISubsystem_RequestShowTokenSKUPurchaseUIWithHandler.png)

```cpp
EModioOpenStoreResult RequestShowTokenSKUPurchaseUIWithHandler(FOnShowTokenPurchaseUIResult Callback, FString SKU)
```
...
|`SKU`|ID of the SKU to purchase, if empty just opens the store normally|
</RefTable>
...
Requests a refreshing of the currently logged in user's entitlements (consuming them if possible). This then executes callbacks in implementations of IModioUIWalletBalanceUpdatedEventReceiver. Requires that a valid portal implementation has been set via RegisterPortalInterface before calling.
...
##### Request Purchase with Entitlement for Mod IDWith Handler

Purchases a mod for the current player, executing the callback upon completion. Requires that a valid portal implementation has been set via RegisterPortalInterface before calling.

![nd_img_ModioUISubsystem_RequestPurchaseWithEntitlementForModIDWithHandler.png](img/refdocs/nd_img_ModioUISubsystem_RequestPurchaseWithEntitlementForModIDWithHandler.png)

```cpp
void RequestPurchaseWithEntitlementForModIDWithHandler(FModioModID ID, FOnPurchaseModDelegate Callback)
```
...
|-|-|
|`Target`|`ModioUISubsystem`|
|`ID`|ID of the mod to purchase between the displayed price and the price in the backend. If there is a mismatch, the purchase will fail.|
...
Requests the purchase of the given Token Pack via the currently active online portal provider. Requires that a valid portal implementation has been set via RegisterPortalInterface before calling.
...
##### Request List User Following Mod Collections

Requests a list of all followed mod collections Executes callbacks in implementations of IModioUICollectionFollowStateChangedReceiver

![nd_img_ModioUISubsystem_RequestListUserFollowingModCollections.png](img/refdocs/nd_img_ModioUISubsystem_RequestListUserFollowingModCollections.png)
...
##### Request List User Following

Requests a list of all users the currently authenticated user follows. Executes callbacks in implementations of IModioUIUserFollowingInfoReceiver.

![nd_img_ModioUISubsystem_RequestListUserFollowing.png](img/refdocs/nd_img_ModioUISubsystem_RequestListUserFollowing.png)
...
Requests a list of all purchasable Token Packs via the currently active online portal provider The result is received by any class implementing the ModioTokenPackReceiver interface via OnListAllTokenPacksRequestCompleted. Requires that a valid portal implementation has been set via RegisterPortalInterface before calling.
...
Requests to follow the given user for the currently authenticated user. Executes callbacks in implementations of IModioUIUserFollowingInfoReceiver.

![nd_img_ModioUISubsystem_RequestFollowUser.png](img/refdocs/nd_img_ModioUISubsystem_RequestFollowUser.png)
...
##### Request Available User Entitlements

Requests the list of the currently logged in user's entitlements and does NOT consume them. The result is returned via the provided callback. Requires that a valid portal implementation has been set via RegisterPortalInterface before calling.

![nd_img_ModioUISubsystem_RequestAvailableUserEntitlements.png](img/refdocs/nd_img_ModioUISubsystem_RequestAvailableUserEntitlements.png)

```cpp
void RequestAvailableUserEntitlements(FOnGetAvailableUserEntitlementsDelegate OnGetUserEntitlements)
```
...
|-|-|
|`Target`|`ModioUISubsystem`|
|`On Get User Entitlements`|The callback to be executed upon completion of the request|
</RefTable>
...
Registers a portal interface that will be used for certain platform specific functionality

![nd_img_ModioUISubsystem_RegisterPortalInterface.png](img/refdocs/nd_img_ModioUISubsystem_RegisterPortalInterface.png)
...
|-|-|
|`Target`|`ModioUISubsystem`|
|`InPortalInterface`|The portal interface to register|
</RefTable>
...
##### Query Input Mode State

Gets the current MouseInputMode State

![nd_img_ModioUISubsystem_QueryInputModeState.png](img/refdocs/nd_img_ModioUISubsystem_QueryInputModeState.png)
...
###### Returns
The current MouseInputMode State.
...
Plays the UI sound feedback associated with the given event key via the current feedback provider.

![nd_img_ModioUISubsystem_PlayUISoundFeedback.png](img/refdocs/nd_img_ModioUISubsystem_PlayUISoundFeedback.png)
...
Plays the UI force feedback associated with the given event key via the current feedback provider.

![nd_img_ModioUISubsystem_PlayUIForceFeedback.png](img/refdocs/nd_img_ModioUISubsystem_PlayUIForceFeedback.png)
...
##### Notify Platform Store Browsing

Notifies the portal interface that the user is currently browsing products from the the platform store, which may affect the behavior of certain UI elements.

![nd_img_ModioUISubsystem_NotifyPlatformStoreBrowsing.png](img/refdocs/nd_img_ModioUISubsystem_NotifyPlatformStoreBrowsing.png)
...
|-|-|
|`Target`|`ModioUISubsystem`|
|`bBrowsing`|Whether the user is currently browsing products from the platform store.|
</RefTable>
...
Updates the current MouseInputMode state, and notifies implementations of IModioUIInputModeChangedReceiver *only* if the state changes.

![nd_img_ModioUISubsystem_NotifyInputModeChange.png](img/refdocs/nd_img_ModioUISubsystem_NotifyInputModeChange.png)
...
##### Is User Following Creator


![nd_img_ModioUISubsystem_IsUserFollowingCreator.png](img/refdocs/nd_img_ModioUISubsystem_IsUserFollowingCreator.png)

```cpp
bool IsUserFollowingCreator(FModioUserID CreatorId)
```
...
Gets the current running in VR state

![nd_img_ModioUISubsystem_IsRunningInVR.png](img/refdocs/nd_img_ModioUISubsystem_IsRunningInVR.png)
...
###### Returns
True if HMD is connected and stereo rendering is enabled
...
##### Get SKUMapping by SKUMapping Array


![nd_img_ModioUISubsystem_GetSKUMappingBySKUMappingArray.png](img/refdocs/nd_img_ModioUISubsystem_GetSKUMappingBySKUMappingArray.png)

```cpp
FModioTokenPack GetSKUMappingBySKUMappingArray(TArray<FModioModMonetizationSKU> SKUMappings, bool bValid)
```
...
##### Get SKUMapping by Id

Looks up the specified SKU by ID in the subsystem's cache. The cache is populated by game code invoking SetCachedSKUMappings.

![nd_img_ModioUISubsystem_GetSKUMappingById.png](img/refdocs/nd_img_ModioUISubsystem_GetSKUMappingById.png)

```cpp
FModioTokenPack GetSKUMappingById(FString ID, bool bValid)
```
...
Returns the currently registered portal interface

![nd_img_ModioUISubsystem_GetPortalInterface.png](img/refdocs/nd_img_ModioUISubsystem_GetPortalInterface.png)
...
#### ModioUIUserFollowingInfoReceiver 
...
##### Request User Following List Change



![nd_img_UserFollowingListProvider_RequestUserFollowingListChange.png](img/refdocs/nd_img_UserFollowingListProvider_RequestUserFollowingListChange.png)
...
| | |
|-|-|
|`Target`|`UserFollowingListProvider`|
|`NewFollowingList`|The new list of users to replace the current list of followers with.|
</RefTable>
...
##### Request Remove Followed User



![nd_img_UserFollowingListProvider_RequestRemoveFollowedUser.png](img/refdocs/nd_img_UserFollowingListProvider_RequestRemoveFollowedUser.png)
...
|-|-|
|`Target`|`UserFollowingListProvider`|
|`NewUnfollowedUser`|the user to remove from the list of currently followed users|
</RefTable>
...
##### Request Add Followed User



![nd_img_UserFollowingListProvider_RequestAddFollowedUser.png](img/refdocs/nd_img_UserFollowingListProvider_RequestAddFollowedUser.png)
...
|-|-|
|`Target`|`UserFollowingListProvider`|
|`NewFollowedUser`|the user to add to the list of currently followed users|
</RefTable>
...
##### Query User Following List


![nd_img_UserFollowingListProvider_QueryUserFollowingList.png](img/refdocs/nd_img_UserFollowingListProvider_QueryUserFollowingList.png)
...
#### WBP_ModView_CarouselFeatured 



###### Inheritance Hierarchy
-> WBP_ModViewTemplate-> UserWidget-> Widget-> Visual-> Object
...
#### WBP_ModView_CarouselFeaturedLarge_Looping 
...
#### WBP_ModView_CarouselFeatured_Looping 
...
#### WBP_ModView_CarouselRegular_Looping 
...
| `FMargin` | `ContentPadding` |  |
| `FModioSoundCueRef` | `NavigateSoundFeedback` |  |
| `FModioForceFeedbackRef` | `PressForceFeedback` |  |
</RefTable>
...
| `UClass*` | `PremiumBadgeWidget` |  |
| `double` | `ModNameTextSize` |  |
| `double` | `ModNameSizeBoxHeight` |  |
| `FVector2D` | `TileSize` |  |
| `EModioLogoSize` | `LogoSizeToDownload` |  |
</RefTable>
...
#### WBP_ModioDefaultModTile_Featured 



###### Inheritance Hierarchy
-> WBP_ModioDefaultModTile-> ModioDefaultModTile-> ModioUIComponentBase-> CommonActivatableWidget-> CommonUserWidget-> UserWidget-> Widget-> Visual-> Object
...
#### WBP_ModioDefaultModTile_FeaturedLarge 
...
| `UObject*` | `HighlightBorderOverrideImage` |  |
| `UObject*` | `BackgroundBorderOverrideImage` |  |
| `TEnumAsByte<E_SpecialButtonContentDirection>` | `AdditionalContentDirection` |  |
</RefTable>
...
#### WBP_ModioDefaultViewMoreButton 



###### Inheritance Hierarchy
-> WBP_ModioDefaultIconButton-> ModioDefaultIconButton-> ModioDefaultTextButton-> ModioButtonWidget-> CommonButtonBase-> CommonUserWidget-> UserWidget-> Widget-> Visual-> Object
...
#### WBP_ModioDefaultViewMoreButton_Featured 
...
#### WBP_ModioDefaultViewMoreButton_FeaturedLarge 
...
#### WBP_ModioModTilePriceWidget_Large 



###### Inheritance Hierarchy
-> WBP_ModioModTilePriceWidget-> UserWidget-> Widget-> Visual-> Object
...
#### ModioUIForceFeedbackEntry 

Struct representing a force feedback entry in a data table
...
| | | |
|-|-|-|
| `TObjectPtr<UForceFeedbackEffect>` | `ForceFeedback` | The force feedback effect to use for the entry |
</RefTable>
...
#### ModioForceFeedbackRef 

Blueprint-compatible struct representing a force feedback reference
...
| | | |
|-|-|-|
| `FName` | `ReferencedForceFeedbackName` | The name of the force feedback effect to reference |
| `TObjectPtr<UForceFeedbackEffect>` | `FallbackForceFeedback` | The force feedback effect to use if the reference is not found |
</RefTable>
...
#### ModioForceFeedbackRefOverride 

Blueprint-compatible struct representing a force feedback reference override
...
| | | |
|-|-|-|
| `bool` | `bOverride` | Whether the force feedback reference is overridden |
| `FModioForceFeedbackRef` | `ForceFeedback` | The force feedback to use if the reference is overridden |
</RefTable>
...
Struct representing a sound entry in a data table
...
| | | |
|-|-|-|
| `TObjectPtr<USoundBase>` | `Sound` | The sound to use for the entry |
</RefTable>
...
Blueprint-compatible struct representing a sound reference
...
| | | |
|-|-|-|
| `FName` | `ReferencedSoundName` | The name of the sound to reference |
| `TObjectPtr<USoundBase>` | `FallbackSound` | The sound to use if the reference is not found |
</RefTable>
...
#### ModioSoundCueRefOverride 

Blueprint-compatible struct representing a sound reference override
...
| | | |
|-|-|-|
| `bool` | `bOverride` | Whether the sound reference is overridden |
| `FModioSoundCueRef` | `Sound` | The sound to use if the reference is overridden |
</RefTable>
...
#### Resolve Force Feedback Override As Exec

Resolves a force feedback reference override to a force feedback effect

![nd_img_ModioForceFeedbackRefLibrary_ResolveOverrideAsExec.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_ResolveOverrideAsExec.png)

```cpp
UForceFeedbackEffect* ResolveOverrideAsExec(FModioForceFeedbackRefOverride Target, bool bOverrideSet)
```
...
| | |
|-|-|
|`Target`|`FModioForceFeedbackRefOverride`|
</RefTable>



##### Returns
The resolved force feedback effect, or null if the override is not set
...
#### Resolve Force Feedback Override

Resolves a force feedback reference override to a force feedback effect

![nd_img_ModioForceFeedbackRefLibrary_ResolveOverride.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_ResolveOverride.png)

```cpp
UForceFeedbackEffect* ResolveOverride(FModioForceFeedbackRefOverride Target, bool bOverrideSet)
```
...
|-|-|
|`Target`|`FModioForceFeedbackRefOverride`|
|`Override Set`|True if the force feedback reference was overridden, false otherwise|
</RefTable>
...
Resolves a force feedback reference to a force feedback effect

![nd_img_ModioForceFeedbackRefLibrary_Resolve.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_Resolve.png)

```cpp
UForceFeedbackEffect* Resolve(FModioForceFeedbackRef Target, bool bResolved)
```
...
| | |
|-|-|
|`Target`|`FModioForceFeedbackRef`|
|`Resolved`|True if the force feedback reference was resolved, false if the fallback effect was used|
</RefTable>



##### Returns
The resolved force feedback effect
...
#### Remove Force Feedback Change Handler

Removes a handler from the list of handlers to be called when the force feedback table changes

![nd_img_ModioForceFeedbackRefLibrary_RemoveForceFeedbackChangeHandler.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_RemoveForceFeedbackChangeHandler.png)

```cpp
void RemoveForceFeedbackChangeHandler(FModioForceFeedbackRefChangeHandler Handler)
```
...
#### Get Valid Force Feedback Keys

Gets the list of valid force feedback keys

![nd_img_ModioForceFeedbackRefLibrary_GetValidForceFeedbackKeys.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_GetValidForceFeedbackKeys.png)

```cpp
TArray<FName> GetValidForceFeedbackKeys()
```
...
##### Returns
The list of valid force feedback keys
...
#### Add Force Feedback Change Handler

Adds a handler to be called when the force feedback table changes

![nd_img_ModioForceFeedbackRefLibrary_AddForceFeedbackChangeHandler.png](img/refdocs/nd_img_ModioForceFeedbackRefLibrary_AddForceFeedbackChangeHandler.png)

```cpp
void AddForceFeedbackChangeHandler(FModioForceFeedbackRefChangeHandler Handler)
```
...
#### Resolve Sound Override As Exec

Resolves a sound reference override to a sound asset

![nd_img_ModioSoundCueRefLibrary_ResolveOverrideAsExec.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_ResolveOverrideAsExec.png)

```cpp
USoundBase* ResolveOverrideAsExec(FModioSoundCueRefOverride Target, bool bOverrideSet)
```
...
| | |
|-|-|
|`Target`|`FModioSoundCueRefOverride`|
</RefTable>



##### Returns
The resolved sound asset, or null if the override is not set
...
#### Resolve Sound Override

Resolves a sound reference override to a sound asset

![nd_img_ModioSoundCueRefLibrary_ResolveOverride.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_ResolveOverride.png)

```cpp
USoundBase* ResolveOverride(FModioSoundCueRefOverride Target, bool bOverrideSet)
```
...
|-|-|
|`Target`|`FModioSoundCueRefOverride`|
|`Override Set`|True if the sound reference was overridden, false otherwise|
</RefTable>
...
Resolves a sound reference to a sound asset

![nd_img_ModioSoundCueRefLibrary_Resolve.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_Resolve.png)

```cpp
USoundBase* Resolve(FModioSoundCueRef Target, bool bResolved)
```
...
| | |
|-|-|
|`Target`|`FModioSoundCueRef`|
|`Resolved`|True if the sound reference was resolved, false if the fallback sound was used|
</RefTable>



##### Returns
The resolved sound asset
...
#### Remove Sound Change Handler

Removes a handler from the list of handlers to be called when the sound table changes

![nd_img_ModioSoundCueRefLibrary_RemoveSoundChangeHandler.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_RemoveSoundChangeHandler.png)

```cpp
void RemoveSoundChangeHandler(FModioSoundCueRefChangeHandler Handler)
```
...
#### Get Valid Sound Keys

Gets the list of valid sound keys

![nd_img_ModioSoundCueRefLibrary_GetValidSoundKeys.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_GetValidSoundKeys.png)

```cpp
TArray<FName> GetValidSoundKeys()
```
...
#### Add Sound Change Handler

Adds a handler to be called when the sound table changes

![nd_img_ModioSoundCueRefLibrary_AddSoundChangeHandler.png](img/refdocs/nd_img_ModioSoundCueRefLibrary_AddSoundChangeHandler.png)

```cpp
void AddSoundChangeHandler(FModioSoundCueRefChangeHandler Handler)
```
...
#### Get Preset Named Filters


![nd_img_ModioUISettings_GetPresetNamedFilters.png](img/refdocs/nd_img_ModioUISettings_GetPresetNamedFilters.png)

```cpp
TArray<FModioPresetFilterParams> GetPresetNamedFilters()
```
...
#### Get Preset Filter by Name


![nd_img_ModioUISettings_GetPresetFilterByName.png](img/refdocs/nd_img_ModioUISettings_GetPresetFilterByName.png)

```cpp
FModioPresetFilterParams GetPresetFilterByName(FText PresetFilterName, bool bSuccess)
```
...
#### Get Mod Display Price Text


![nd_img_ModioUICommonFunctionLibrary_GetModDisplayPriceText.png](img/refdocs/nd_img_ModioUICommonFunctionLibrary_GetModDisplayPriceText.png)

```cpp
FText GetModDisplayPriceText(FModioModInfo InModInfo)
```
...
#### Async Load Class Array

Utility method to async load an array of soft class pointers //

![nd_img_ModioUICommonFunctionLibrary_AsyncLoadClassArray.png](img/refdocs/nd_img_ModioUICommonFunctionLibrary_AsyncLoadClassArray.png)

```cpp
void AsyncLoadClassArray(TArray<TSoftClassPtr<UObject> > SoftClassPtrs, FModioAsyncLoadClassesComplete OnComplete)
```
...
|-|-|
|`SoftClassPtrs`||
|`On Complete`|Delegate to execute once loading is complete|
</RefTable>
...
#### EModioUIInputMode {#EModioUIInputMode} 
...
#### EModioUIUserFollowingEventType {#EModioUIUserFollowingEventType} 
...
| | |
|-|-|
| `ListUserFollowing` | Event to list user following * |
| `FollowUser` | Event when a user is followed * |
| `UnfollowUser` | Event when a user is unfollowed * |
</RefTable>
