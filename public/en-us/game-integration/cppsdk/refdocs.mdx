...
```cpp
void PurchaseModAsync(Modio::ModID ModID, int ExpectedVirtualCurrencyPrice, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void InstallOrUpdateServerModsAsync(int Mods, std::function<void (Modio::ErrorCode)> Callback)
```
...
```cpp
void RegisterClientModsWithServerAsync(int ModIDs, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void ListModCollectionsAsync(Modio::FilterParams Filter, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void GetModCollectionInfoAsync(Modio::ModCollectionID ModCollectionId, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void GetModCollectionModsAsync(Modio::ModCollectionID ModCollectionId, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void FollowModCollectionAsync(Modio::ModCollectionID ModCollectionToFollow, std::function<void (Modio::ErrorCode, int)> OnFollowComplete)
```
...
```cpp
void ListUserFollowedModCollectionsAsync(Modio::FilterParams Filter, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void GetModCollectionMediaAsync(Modio::ModCollectionID CollectionId, Modio::LogoSize LogoSize, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
```cpp
void GetModCollectionMediaAsync(Modio::ModCollectionID CollectionId, Modio::AvatarSize AvatarSize, std::function<void (Modio::ErrorCode, int)> Callback)
```
...
| | | |
|-|-|-|
| [`ListType`](#_2282071571968) | InternalList |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | RootDirectory | Path to a directory to treat as the root of the mod. The SDK will compress all contents of this folder into a .zip archive, with a relative path based on this directory. This directory will not be created itself, the contents will exist at the top level of the archive. |
| [`int`](#_2282018533968) | Version | Optional version string for this modfile release |
| [`int`](#_2282018533968) | Changelog | Optional changelog string for this modfile release |
| [`int`](#_2282018533968) | bSetAsActive | Should this mod be set as active/latest release? Defaults to true if not set. |
| [`int`](#_2282018533968) | MetadataBlob | Optional metadata blob for this mod |
| [`int`](#_2282018533968) | MetadataKvp | Optional key-value-pair metadata for this mod |
| [`int`](#_2282018533968) | Platforms | Optional vector of platforms for this modfile |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | PathToLogoFile | Path to the logo for the mod. Must point to a valid file on disk or the mod will not be created on the server. |
| [`std::string`](#_2282047976032) | Name | The name of the mod |
| [`std::string`](#_2282047976032) | Summary | A brief summary of what the mod is |
| [`int`](#_2282018533968) | NamePath | Optional override for the name 'slug' in the mod's URL |
| [`int`](#_2282018533968) | Visibility | Optional override for the mod's visibility status. Defaults to Public (1) |
| [`int`](#_2282018533968) | Description | Optional long description of the mod |
| [`int`](#_2282018533968) | HomepageURL | Optional URL to the mod's homepage. Must be a valid URL |
| [`int`](#_2282018533968) | Stock | Optional quantity limit on the mod |
| [`int`](#_2282018533968) | MaturityRating | Bitwise mask of flags indicating mature content |
| [`int`](#_2282018533968) | CommunityOptions | Community options for the mod |
| [`int`](#_2282018533968) | MetadataBlob | Optional metadata blob for this mod |
| [`int`](#_2282018533968) | MetadataKvp | Optional key-value-pair metadata for this mod |
| [`int`](#_2282018533968) | Tags | Optional list of mod tags. All tags must be supported by the parent game to be applied |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | RootDirectory | Path to a directory to treat as the root of the mod source. The SDK will compress all contents of this folder into a .zip archive, with a relative path based on this directory. This directory will not be created itself, the contents will exist at the top level of the archive. |
| [`int`](#_2282018533968) | Version | Optional version string for this modfile release |
| [`int`](#_2282018533968) | Changelog | Optional changelog string for this modfile release |
| [`int`](#_2282018533968) | MetadataBlob | Optional metadata blob for this mod |
| [`int`](#_2282018533968) | Platforms | Optional vector of platforms for this modfile |
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | Name | The name of the mod |
| [`int`](#_2282018533968) | Summary | A brief summary of what the mod is |
| [`int`](#_2282018533968) | NamePath | Optional override for the name 'slug' in the mod's URL |
| [`int`](#_2282018533968) | Visibility | Optional override for the mod's visibility status. Defaults to Public (1) |
| [`int`](#_2282018533968) | Description | Optional long description of the mod |
| [`int`](#_2282018533968) | HomepageURL | Optional URL to the mod's homepage. Must be a valid URL |
...
| [`int`](#_2282018533968) | MetadataBlob | Optional metadata blob for this mod |
| [`int`](#_2282018533968) | MetadataKvp | Optional key-value-pair metadata for this mod |
| [`int`](#_2282018533968) | LogoPath | Optional path to a new logo image |
| [`int`](#_2282018533968) | Tags | Optional tags vector for this mod |
</RefTable>
...
##### RevenueFilterType {#_2282072700480} 
...
```cpp
FilterParams &MarkedLiveAfter(int LiveAfter, bool RoundToHour = true)
```
...
```cpp
FilterParams &MarkedLiveBefore(int LiveBefore, bool RoundToHour = true)
```
...
| | | |
|-|-|-|
| [`SortFieldType`](#_2282072696608) | SortField |  |
| [`SortDirection`](#_2282072699472) | Direction |  |
| [`int`](#_2282018533968) | AuthorUserIds |  |
| [`int`](#_2282018533968) | SearchKeywords |  |
| [`int`](#_2282018533968) | DateRangeBegin |  |
| [`int`](#_2282018533968) | DateRangeEnd |  |
| [`int`](#_2282018533968) | Tags |  |
| [`int`](#_2282018533968) | ExcludedTags |  |
| [`int`](#_2282018533968) | IncludedIDs |  |
| [`int`](#_2282018533968) | ExcludedIDs |  |
| [`int`](#_2282018533968) | Revenue |  |
| [`int`](#_2282018533968) | Maturity |  |
| [`int`](#_2282018533968) | MetadataBlobSearchString |  |
| [`_Bool`](#_2282018533840) | IsPaged |  |
| [`std::size_t`](#_2282018534192) | Index |  |
| [`std::size_t`](#_2282018534192) | Count |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int32_t`](#_2282018533968) | PageIndex |  |
| [`std::int32_t`](#_2282018533968) | PageSize |  |
| [`std::int32_t`](#_2282018533968) | PageCount |  |
| [`std::int32_t`](#_2282018533968) | TotalResultCount |  |
| [`std::int32_t`](#_2282018533968) | ResultCount |  |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | ID | The ID of the mod |
| [`std::atomic<Modio::ModState>`](#_2282072909296) | CurrentState | The status of the mod, is it pending installation, is it installed but needing an update, etc |
| [`int`](#_2282018533968) | RollbackState |  |
| [`ModInfo`](#_2282071693680) | ModProfile | Mod descriptor from the REST API |
| [`std::atomic<uint8_t>`](#_2282048547680) | LocalUserSubscriptionCount | Reference counting to allow automatic uninstallation of unused local mods |
| [`int`](#_2282018533968) | LocalUserSubscriptions |  |
| [`std::string`](#_2282047976032) | PathOnDisk |  |
| [`Modio::FileSize`](#_2282071367648) | SizeOnDisk |  |
| [`std::atomic<_Bool>`](#_2282048545920) | ShouldNotRetry | flag if this mod should not be processed because it encountered an unrecoverable error during installation/update. This should not be saved to disk as we will more than likely want to retry next session |
| [`Modio::ErrorCode`](#_2282050767680) | NeverRetryReason |  |
| [`Modio::ErrorCode`](#_2282050767680) | LastErrorCode |  |
| [`uint8_t`](#_2282018534064) | RetriesRemainingThisSession |  |
</RefTable>
...
##### EModProgressState {#_2282034661008} 
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | ID | The mod ID of the mod being processed |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | InternalData |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::uint64_t`](#_2282018534192) | TotalFilesize | Total size of all the dependency files in bytes. |
| [`std::uint64_t`](#_2282018534192) | TotalFilesizeUncompressed | Total Size of the uncompressed dependency files in bytes. |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | WalletBalance | Updated wallet balance from syncing entitlements |
</RefTable>
...
| | | |
|-|-|-|
| [`UnderlyingIntegerType`](#_2282020357504) | Value |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | InternalCode |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | InternalAddress |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | InternalApiKey |  |
</RefTable>
...
| | | |
|-|-|-|
| [`uint8_t[16]`](#_2282049185744) | Raw8 |  |
| [`uint64_t[2]`](#_2282071383744) | Raw64 |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | InternalGuid |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | AuthToken | AuthToken String received by an authentication provider, that later is used to verify a user on the mod.io API |
| [`int`](#_2282018533968) | UserEmail | UserEmail Optional string that associates an email with a user |
| [`_Bool`](#_2282018533840) | bUserHasAcceptedTerms | bUserHasAcceptedTerms Boolean value that signals when a user has accepted the mod.io Terms of Service. True when they are accepted, false otherwise. |
| [`_Bool`](#_2282018533840) | bURLEncodeAuthToken | bURLEncodeAuthToken Boolean value to let the SDK know if the AuthToken requires URL encoding before sending the string to the mod.io API. By default, it would not perform URL encoding. |
| [`int`](#_2282018533968) | ExtendedParameters | ExtendedParameters A map to store extended parameters required by some providers. |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Field | String description of the field failing validation |
| [`std::string`](#_2282047976032) | Error | String containing the reason for the validation failure |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | ExtendedParameters | ExtendedParameters A map to store extended parameters required by some portals. |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | SessionId | Set a custom Session Id to be used in the metrics service for your session |
| [`int`](#_2282018533968) | ModIds | Includes mods which will be tracked as part of the metrics service |
</RefTable>
...
##### VirusScanStatus {#_2282071465360} 
...
| | | |
|-|-|-|
| [`Modio::FileMetadataID`](#_2282071363968) | MetadataId | Unique modfile id. |
| [`Modio::ModID`](#_2282071355840) | ModId | Unique mod id. |
| [`std::int64_t`](#_2282018534032) | DateAdded | Unix timestamp of date file was added. |
| [`VirusScanStatus`](#_2282071465360) | CurrentVirusScanStatus | Current virus scan status of the file. For newly added files that have yet to be scanned this field will change frequently until a scan is complete |
| [`VirusStatus`](#_2282071467152) | CurrentVirusStatus | Was a virus detected? |
| [`std::uint64_t`](#_2282018534192) | Filesize | Size of the file in bytes. |
| [`std::uint64_t`](#_2282018534192) | FilesizeUncompressed | Size of the uncompressed file in bytes. |
| [`std::string`](#_2282047976032) | Filename | Filename including extension. |
| [`std::string`](#_2282047976032) | Version | Release version this file represents. |
| [`std::string`](#_2282047976032) | Changelog | Changelog for the file. |
| [`std::string`](#_2282047976032) | MetadataBlob | Metadata stored by the game developer for this file. |
| [`std::string`](#_2282047976032) | DownloadBinaryURL | Modfile download URL |
| [`std::int64_t`](#_2282018534032) | DownloadExpiryDate | Modfile download expiry date |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int64_t`](#_2282018534032) | PopularityRankPosition | Current rank of the mod. |
| [`std::int64_t`](#_2282018534032) | PopularityRankTotalMods | Number of ranking spots the current rank is measured against. |
| [`std::int64_t`](#_2282018534032) | DownloadsTotal | Number of total mod downloads. |
| [`std::int64_t`](#_2282018534032) | SubscribersTotal | Number of total users who have subscribed to the mod. |
| [`std::int64_t`](#_2282018534032) | RatingTotal | Number of times this mod has been rated. |
| [`std::int64_t`](#_2282018534032) | RatingPositive | Number of positive ratings. |
| [`std::int64_t`](#_2282018534032) | RatingNegative | Number of negative ratings. |
| [`std::int64_t`](#_2282018534032) | RatingPercentagePositive | Number of positive ratings, divided by the total ratings to determine it’s percentage score. |
| [`double`](#_2282018534256) | RatingWeightedAggregate | Overall rating of this item calculated using the [Wilson score confidence interval](https://www.evanmiller.org/how-not-to-sort-by-average-Ratinghtml). This column is good to sort on, as it will order items based on number of ratings and will place items with many positive ratings above those with a higher score but fewer ratings. |
| [`std::string`](#_2282047976032) | RatingDisplayText | Textual representation of the rating in format: Overwhelmingly Positive -> Very Positive -> Positive -> Mostly Positive -> Mixed -> Negative -> Mostly Negative -> Very Negative -> Overwhelmingly Negative -> Unrated |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::UserID`](#_2282071351456) | UserId | Unique id for the user |
| [`std::string`](#_2282047976032) | Username | Username of the user |
| [`int`](#_2282018533968) | AuthToken | Authentification token of the user |
| [`std::int64_t`](#_2282018534032) | DateOnline | Unix timestamp the user was last online |
| [`std::string`](#_2282047976032) | ProfileUrl | URL of the user's mod.io profile |
| [`Modio::Detail::Avatar`](#_2282071623904) | Avatar | Cached information about the user's avatar |
| [`std::string`](#_2282047976032) | DisplayNamePortal | The display name of the User for the given Portal that the mod search is coming from * ie if the Portal is PSN, then this is the owning user's PSN profile name if accounts are linked. |
</RefTable>
...
| | | |
|-|-|-|
| [`uint8_t`](#_2282018534064) | Id | Unique identifier for the SKU |
| [`std::string`](#_2282047976032) | Sku | Name of the actual SKU pack |
| [`std::string`](#_2282047976032) | Portal | Portal that this SKU is associated with |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Tag |  |
| [`std::string`](#_2282047976032) | TagLocalized |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Key |  |
| [`std::string`](#_2282047976032) | Value |  |
</RefTable>
...
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | ModId | Unique Mod ID |
| [`std::string`](#_2282047976032) | ProfileName | Name of the mod |
| [`std::string`](#_2282047976032) | ProfileSummary | Summary of the mod |
| [`std::string`](#_2282047976032) | ProfileDescription | Detailed description in HTML format |
| [`std::string`](#_2282047976032) | ProfileDescriptionPlaintext | Detailed description in plaintext |
| [`std::string`](#_2282047976032) | ProfileURL | URL to the mod profile |
| [`Modio::User`](#_2282071636448) | ProfileSubmittedBy | Information on the user who submitted the mod |
| [`std::int64_t`](#_2282018534032) | ProfileDateAdded | Unix timestamp of the date the mod was registered |
| [`std::int64_t`](#_2282018534032) | ProfileDateUpdated | Unix timestamp of the date the mod was updated |
| [`std::int64_t`](#_2282018534032) | ProfileDateLive | Unix timestamp of the date the mod was marked live |
| [`Modio::ProfileMaturity`](#_2282071559456) | ProfileMaturityOption | Object representing a mod.io user profile	* Maturity options flagged by the mod developer, this is only relevant if the parent game allows mods to	* be labeled as mature. The value of this field will default to None unless the parent game allows * to flag mature content. |
| [`Modio::ModCommunityOptionsFlags`](#_2282071532032) | CommunityOptions | Community options for the mod |
| [`std::string`](#_2282047976032) | MetadataBlob | Metadata stored by the game developer. |
| [`int`](#_2282018533968) | FileInfo | Information about the mod's most recent public release |
| [`int`](#_2282018533968) | MetadataKvp | Arbitrary key-value metadata set for this mod |
| [`int`](#_2282018533968) | Tags | Tags this mod has set |
| [`std::size_t`](#_2282018534192) | NumGalleryImages | Number of images in the mod's media gallery |
| [`Modio::GalleryList`](#_2282071662080) | GalleryImages | List of images in the mod's media gallery |
| [`Modio::YoutubeURLList`](#_2282071597168) | YoutubeURLs | List of youtube links provided by the creator of the mod |
| [`Modio::SketchfabURLList`](#_2282071600048) | SketchfabURLs | List of sketchfab links provided by the creator of the mod |
| [`Modio::ModStats`](#_2282071541168) | Stats | Stats and rating information for the mod |
| [`Modio::Detail::Logo`](#_2282071668896) | ModLogo | Media data related to the mod logo |
| [`std::string`](#_2282047976032) | Version | The current ModInfo version. This property is updated when changes to the class happen. This is NOT the version of the mod itself. Mod versioning is tied to FileInfo, not ModInfo. |
| [`Modio::ModServerSideStatus`](#_2282071692528) | ModStatus | The current ModStatus on the server: Accepted, NotAccepted, or Deleted. |
| [`Modio::ObjectVisibility`](#_2282071430912) | Visibility | The visibility status of the mod, default to Public |
| [`uint64_t`](#_2282018534192) | Price | Price of this mod |
| [`int`](#_2282018533968) | SKUMappings | SKU Mappings for this mod for monetization purposes |
| [`_Bool`](#_2282018533840) | Dependencies | If this mod has any direct dependencies |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::GameID`](#_2282071368768) | GameID | The mod.io-provided ID for the game. |
| [`Modio::ApiKey`](#_2282071344832) | APIKey | The mod.io-provided API key for your application or game. |
| [`Modio::UserHandleType`](#_2282047976032) | User | Unique identifier for the local session, which will optionally contain user data for an authenticated mod.io user (once authentication is completed). |
| [`Modio::Portal`](#_2282071301776) | PortalInUse | The storefront or distribution method to use. The API uses this parameter to serve platform-compliant user names. Use `Modio::Portal::None` if your title does not require this. |
| [`Modio::Environment`](#_2282071298960) | GameEnvironment | The mod.io environment you want to run the SDK on. |
| [`int`](#_2282018533968) | ExtendedParameters | Platform-specific extended initialization parameters. See xref:Platform-specific Notes[] for more information regarding any special values your platform requires or supports. |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | ID | ID for the mod that the event occurred on |
| [`EventType`](#_2282034692656) | Event | What type of event occurred |
| [`Modio::ErrorCode`](#_2282050767680) | Status | Empty if operation completed successfully, truthy/contains error code if operation failed |
</RefTable>
...
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | ModID | Unique mod id. |
| [`std::string`](#_2282047976032) | ModName | Name of the mod |
| [`std::int64_t`](#_2282018534032) | DateAdded | Unix timestamp of the date the mod was registered |
| [`std::int64_t`](#_2282018534032) | DateUpdated | Unix timestamp of the date the mod was updated |
| [`std::uint8_t`](#_2282018534064) | DependencyDepth | The level at which this dependency sits. When greater than zero (0), it means that this dependency relies on additional dependencies. |
| [`Modio::Detail::Logo`](#_2282071668896) | Logo | Media data related to the mod logo |
| [`int`](#_2282018533968) | FileInfo | Information about the mod's most recent public release |
| [`Modio::ModServerSideStatus`](#_2282071692528) | Status | The current ModStatus on the server: Accepted, NotAccepted, or Deleted. |
| [`Modio::ObjectVisibility`](#_2282071430912) | Visibility | The visibility status of the mod, default to Public |
</RefTable>
...
| | | |
|-|-|-|
| [`int`](#_2282018533968) | TokensAllocated | Amount of tokens that were issued for this specific entitlement consumption |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | TransactionId | ID of the transaction to redeem this entitlement |
| [`Modio::EntitlementConsumptionState`](#_2282034763008) | TransactionState | State of the transaction |
| [`std::string`](#_2282047976032) | SkuId | ID of the SKU that we attempted to consume |
| [`_Bool`](#_2282018533840) | EntitlementConsumed | Whether this entitlement was consumed or not |
| [`Modio::EntitlementType`](#_2282034764256) | EntitlementType | Type of Entitlement that was consumed |
| [`Modio::EntitlementConsumptionVirtualCurrencyDetails`](#_2282034765008) | VirtualCurrencyDetails | Details about |
</RefTable>
...
| | | |
|-|-|-|
| [`uint64_t`](#_2282018534192) | Balance |  |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::GameID`](#_2282071368768) | GameID | Unique game id |
| [`std::int64_t`](#_2282018534032) | ModCountTotal | Available mod count for the game |
| [`std::int64_t`](#_2282018534032) | ModDownloadsToday | Mods downloaded today for the game |
| [`std::int64_t`](#_2282018534032) | ModDownloadsTotal | Total Mods downloaded for the game |
| [`std::int64_t`](#_2282018534032) | ModDownloadsDailyAverage | Average mods downloaded on a daily basis |
| [`std::int64_t`](#_2282018534032) | ModSubscribersTotal | Number of total users who have subscribed to the mods for the game |
| [`std::int64_t`](#_2282018534032) | DateExpires | Unix timestamp until this game's statistics are considered stale |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Tag | The original raw unlocalized tag value used by the REST API |
| [`int`](#_2282018533968) | Translations | Culture code -> Localized tag value string mapping for all configured languages. |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | GroupName | Localized display string for this tag category's name |
| [`int`](#_2282018533968) | Tags | Localized display strings for all valid values in this tag category |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | TagGroupName | Raw unlocalized tag group name |
| [`int`](#_2282018533968) | TagGroupValues | Valid raw unlocalized tag values this group contains |
| [`int`](#_2282018533968) | TagGroupNameLocData | Culture code -> localized tag category name mapping for all configured languages |
| [`int`](#_2282018533968) | TagGroupValueLocData | Localization data for this tag category's values in all configured languages |
| [`_Bool`](#_2282018533840) | bAllowMultipleSelection | True if multiple tags from the group can be used simultaneously |
| [`_Bool`](#_2282018533840) | bHidden | True if only visible by admins |
| [`_Bool`](#_2282018533840) | bLocked | True if only editable by admins |
| [`std::string`](#_2282047976032) | Locale | the culture code for the mod.io locale at the time the mod.io API returned this data |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModfilePlatform`](#_2282071305296) | Platform | Platform that the game supports |
| [`_Bool`](#_2282018533840) | Locked | Whether or not this platform is Locked from having files submitted to it |
| [`_Bool`](#_2282018533840) | Moderated | Whether or not files submitted for this platform are required to go through moderation |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Filename |  |
| [`std::string`](#_2282047976032) | Original |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Label |  |
| [`std::string`](#_2282047976032) | Url |  |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | Primary |  |
| [`std::string`](#_2282047976032) | Dark |  |
| [`std::string`](#_2282047976032) | Light |  |
| [`std::string`](#_2282047976032) | Success |  |
| [`std::string`](#_2282047976032) | Warning |  |
| [`std::string`](#_2282047976032) | Danger |  |
</RefTable>
...
|-|-|-|
| [`Modio::GameID`](#_2282071368768) | GameID | Unique Game ID |
| [`std::int64_t`](#_2282018534032) | DateAdded | Unix timestamp of date game was registered |
| [`std::int64_t`](#_2282018534032) | DateUpdated | Unix timestamp of date game was updated |
| [`std::int64_t`](#_2282018534032) | DateLive | Unix timestamp of date game was set live |
| [`std::string`](#_2282047976032) | UgcName | Word used to describe user-generated content (mods, items, addons etc) |
| [`Modio::Detail::Icon`](#_2282073216368) | Icon | Contains media URLs to the icon for the game |
| [`Modio::Detail::Logo`](#_2282071668896) | Logo | Contains media URLs to the logo for the game |
| [`Modio::HeaderImage`](#_2282073268816) | HeaderImage | Contains media URLs to the preview header image for the game |
| [`std::string`](#_2282047976032) | Name | Name of the game |
| [`std::string`](#_2282047976032) | Summary | Summary of the game's mod support |
| [`std::string`](#_2282047976032) | Instructions | A guide about creating and uploading mods for this game to mod.io |
| [`std::string`](#_2282047976032) | InstructionsUrl | Link to a mod.io guide, modding wiki, or a page where modders can learn how to make and submit mods to this game's profile |
| [`std::string`](#_2282047976032) | ProfileUrl | URL to the game |
| [`Modio::Theme`](#_2282073273328) | Theme | Theme color values for the game |
| [`Modio::GameStats`](#_2282073195056) | Stats | Numerous aggregate stats for the game |
| [`int`](#_2282018533968) | OtherUrls | Creator defined URLs to share |
| [`int`](#_2282018533968) | PlatformSupport | Platforms supported by this title |
| [`Modio::GameCommunityOptionsFlags`](#_2282073234048) | CommunityOptions | Community options for the game |
| [`Modio::GameMonetization`](#_2282073257184) | GameMonetizationOptions | Monetization options for the game |
| [`Modio::GameMaturityOptionsFlags`](#_2282073244448) | MaturityOptions | Maturity options for the game |
| [`std::string`](#_2282047976032) | VirtualTokenName | Name of the Virtual Tokens for this game |
| [`int`](#_2282018533968) | TagOptions | Tags for this game |
</RefTable>
...
| | | |
|-|-|-|
| [`std::int64_t`](#_2282018534032) | DownloadsToday | Number of mod collection downloads today. |
| [`std::int64_t`](#_2282018534032) | DownloadsTotal | Number of total mod collection downloads. |
| [`std::int64_t`](#_2282018534032) | DownloadsUnique | Number of unique mod collection downloads. |
| [`std::int64_t`](#_2282018534032) | RatingTotal30Days | Number of times this mod collection has been rated. |
| [`std::int64_t`](#_2282018534032) | RatingPositive30Days | Number of positive ratings over 30 days. |
| [`std::int64_t`](#_2282018534032) | RatingNegative30Days | Number of negative ratings over 30 days. |
| [`std::int64_t`](#_2282018534032) | RatingTotal | Number of times this mod collection has been rated. |
| [`std::int64_t`](#_2282018534032) | RatingPositive | Number of positive ratings. |
| [`std::int64_t`](#_2282018534032) | RatingNegative | Number of negative ratings. |
| [`std::int64_t`](#_2282018534032) | NumberOfComments | Number of comments. |
| [`std::int64_t`](#_2282018534032) | NumberOfFollowers | Number of followers. |
| [`std::int64_t`](#_2282018534032) | NumberOfMods | Number of mods in the collection. |
</RefTable>
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | PathToLogoFile | Path to the logo for the mod collection . Must point to a valid file on disk or the mod will not be created on the server. |
| [`std::string`](#_2282047976032) | Name | The name of the mod collection |
| [`std::string`](#_2282047976032) | Summary | A brief summary of what the mod collection is |
| [`std::string`](#_2282047976032) | Category | A category for the mod collection |
| [`Modio::ObjectVisibility`](#_2282071430912) | Visibility | Optional override for the mod collection's visibility status. Defaults to Public (1) |
| [`int`](#_2282018533968) | Mods | Optional override for the list of contained mods |
| [`int`](#_2282018533968) | NamePath | Optional override for the name 'slug' in the mod collection 's URL |
| [`int`](#_2282018533968) | Description | Optional long description of the mod collection |
| [`int`](#_2282018533968) | Tags | Optional list of mod collection tags. All tags must be supported by the parent game to be applied |
</RefTable>
...
|-|-|-|
| [`int`](#_2282018533968) | LogoPath | Optional path to a new logo image |
| [`int`](#_2282018533968) | Name | The name of the mod collection |
| [`int`](#_2282018533968) | Summary | A brief summary of what the mod collection is |
| [`int`](#_2282018533968) | Category | A category for the mod collection |
| [`int`](#_2282018533968) | Visibility | Optional override for the mod collection's visibility status. Defaults to Public (1) |
| [`int`](#_2282018533968) | Mods | Optional override for the list of contained mods |
| [`int`](#_2282018533968) | NamePath | Optional override for the name 'slug' in the mod collection's URL |
| [`int`](#_2282018533968) | Description | Optional long description of the mod collection |
| [`int`](#_2282018533968) | Tags | Optional tags vector for this mod collection |
</RefTable>
...
| | | |
|-|-|-|
| [`struct TermsButtons`](#_2282073604576) | Buttons |  |
| [`struct TermsLinks`](#_2282073606080) | Links |  |
| [`std::string`](#_2282047976032) | TermsText | The plaintext version of the mod.io terms of use |
</RefTable>
...
| | | |
|-|-|-|
| [`Modio::ModID`](#_2282071355840) | AssociatedModID | The mod the purchase was for |
| [`uint64_t`](#_2282018534192) | Price | The price the mod was purchased for |
| [`uint64_t`](#_2282018534192) | UpdatedUserWalletBalance | The updated balance in the user's wallet after the transaction |
| [`Modio::ModInfo`](#_2282071693680) | Mod | ModInfo of the mod that was purchase and subscribed to |
</RefTable>
...
```cpp
explicit ServerInitializeOptions(Modio::GameID GameID, Modio::ApiKey APIKey, Modio::Environment GameEnvironment, Modio::Portal PortalInUse, Modio::UserHandleType LocalSessionIdentifier, std::string &ModsDirectory, std::string &Token, int Mods)
```
...
| | | |
|-|-|-|
| [`std::string`](#_2282047976032) | ModsDirectory | The directory this Server should store its modfiles in. |
| [`std::string`](#_2282047976032) | Token | The S2S token for this Server. |
| [`int`](#_2282018533968) | Mods | The base mods for this Server. |
</RefTable>
...
### ModfilePlatform {#_2282071305296} 
...
### AuthenticationProvider {#_2282071423616} 
...
### ObjectVisibility {#_2282071430912} 
...
### StorageLocation {#_2282071435472} 
...
### ModCommunityOptions {#_2282071529872} 
...
### ModServerSideStatus {#_2282071692528} 
...
### FilesystemError {#_2282071752352} 
...
### ModManagementError {#_2282072137376} 
...
### ModValidationError {#_2282072154944} 
...
### MonetizationError {#_2282072169152} 
...
### ParentalControlRestriction {#_2282072188064} 
...
### PremiumFeaturesError {#_2282072217952} 
...
### ErrorConditionTypes {#_2282072300032} 
...
### EntitlementConsumptionState {#_2282034763008} 
...
### EntitlementType {#_2282034764256} 
...
### GameCommunityOptions {#_2282073230544} 
...
### GameMaturityOptions {#_2282073243184} 
...
### GameMonetizationOptions {#_2282073253680} 
